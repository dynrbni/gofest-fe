    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      {filteredEvents.length > 0 ? (
                ...
                <div>
                  <div className="relative aspect-[16/9] bg-slate-100">
                    ...
                    <div className="absolute top-3 left-3">
                      <span className="bg-brand-900/90 text-white text-[10px] font-bold px-2.5 py-1 rounded-full backdrop-blur-xs">
                        {event.category}
                      </span>
                    </div>
                    ...
                    <div className="absolute top-3 right-3">
                      {event.status === 'published' ? (
                        <span className="bg-emerald-600 text-white text-[10px] font-extrabold px-2.5 py-1 rounded-full shadow-sm">
                          PUBLISHED
                        </span>
                      ) : event.status === 'pending_review' ? (
                        <span className="bg-amber-500 text-white text-[10px] font-extrabold px-2.5 py-1 rounded-full shadow-sm">
                          PENDING REVIEW
                        </span>
                      ) : (
                        <span className="bg-rose-600 text-white text-[10px] font-extrabold px-2.5 py-1 rounded-full shadow-sm">
                          DITOLAK
                        </span>
                      )}
                    </div>
        ...
        <div className="bg-white rounded-2xl p-12 text-center border border-slate-200 space-y-3">
          ...
          <Link
            to="/eo/events/new"
            className="inline-block bg-brand-600 text-white font-bold text-xs px-4 py-2 rounded-xl"
          >
            Buat Event Sekarang
          </Link>
        </div>
